            ...
            <div className="flex flex-col gap-3">
              {channels.map((c) => (
                <a
                  ...
                  className="group flex items-center gap-4 rounded-card border border-line bg-white p-5 transition-all hover:-translate-y-0.5 hover:border-brass-3 hover:shadow-soft"
                >
              ...
              <div className="mt-2 rounded-card border border-line bg-white p-5">
