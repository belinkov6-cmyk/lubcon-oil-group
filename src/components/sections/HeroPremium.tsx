  ...
  return (
    <section className="relative isolate -mt-[65px] overflow-hidden bg-hero-bg0 sm:-mt-[73px]">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden rtl:-scale-x-100" aria-hidden="true">
        ...
        <span className="pointer-events-none absolute left-[83%] top-[67%] hidden max-w-[6.5rem] -translate-x-1/2 -translate-y-1/2 select-none text-balance text-center font-display text-[22px] font-extrabold uppercase leading-[1.02] tracking-[0.06em] text-gold-hi rtl:-scale-x-100 xl:block 2xl:max-w-[8rem] 2xl:text-[26px]">
          {t('canisterLabel')}
