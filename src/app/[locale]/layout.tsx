...
import { fontSans, fontDisplay, fontDisplayRu, fontDisplayAr } from '../fonts';
...
export default async function LocaleLayout({ children, params }: Props) {
  ...
  return (
    <html
      ...
      dir={dir}
      data-theme="light"
      className={`${fontSans.variable} ${fontDisplay.variable} ${fontDisplayRu.variable} ${fontDisplayAr.variable}`}
